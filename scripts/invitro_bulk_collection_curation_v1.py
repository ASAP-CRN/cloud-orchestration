...
for ds in datasets:
  ...
  for d in dirs:
    ...
    skip_archive = False
    if d in ["spatial_visium", "spatial_geomx","pmdbs_bulk_rnaseq","pmdbs_sc_rnaseq","mouse_bulk_rnaseq","mouse_sc_rnaseq","invitro_bulk_rnaseq"]:
      # curated artifacts
