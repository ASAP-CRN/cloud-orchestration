...
RELEASE_VERSION = "v4.0.2"    # e.g. "v4.1.0"
RELEASE_TYPE = "Urgent"        # "Urgent" | "Minor" | "Major"
CDE_VERSION = "v4.2"          # e.g. "v3.3"
RELEASE_DOI = "10.5281/zenodo.19289362"              # Zenodo concept DOI for the release itself, or ""
